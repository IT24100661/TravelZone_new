...
import { MapPin, DollarSign, BookOpen, Plus, X, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8">
        {success && (
          <div className="mb-5 bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-sm">{success}</div>
        )}
        {error && (
